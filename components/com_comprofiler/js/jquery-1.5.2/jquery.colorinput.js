...
(function($) {
    ...
    $.colorInput = function(input, options) {
        ...
        var setValueHex = function(val, doDraw) {
            ...
            valueHex = val;
            $input.val(val[0] == "#" && options.noHash ? val.slice(1) : val);

            control.isChanged = originalValueHex && valueHex != originalValueHex;
