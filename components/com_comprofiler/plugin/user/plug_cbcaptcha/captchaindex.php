...
* @version $Id: captchaindex.php 978 2010-04-07 14:21:19Z beat $
...
if ( isset($_GET['captchaurlmode']) && isset($_GET['captchasid']) ) {
	$urlmode = $_GET['captchaurlmode']; // Expected values image or audio
