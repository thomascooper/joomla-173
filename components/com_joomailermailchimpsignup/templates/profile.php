...
<button class="button validate" type="submit" onclick="<?php if(version_compare(JVERSION,'1.6.0','ge')){ ?>Joomla.<?php } ?>submitbutton( this.form );return false;"><?php echo JText::_('Save'); ?></button>
