		...
		<div class="setting">
			<ul>
				<li>
					...
					<?php echo $objJFormShowlist->showlistDropDownListFrontEnd('showlist_id', 'showlist_id');?>
				</li>
				<li>
					<label><?php echo JText::_('PLG_EDITOR_SHOWCASE');?></label>
					<?php echo $objJFormShowcase->showcaseDropDownListFrontEnd('showcase_id', 'showcase_id');?>
				</li>
			</ul>
		</div>
		<div class="parameter">
