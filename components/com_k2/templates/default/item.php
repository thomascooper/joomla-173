...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>"> 
  ...
  <div class="itemHeader">
    <?php /*?><?php if($this->item->params->get('itemDateCreated') && !$mobile): ?>
    <!-- Date created --> 
    <span class="itemDateCreated"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </span>
    <?php endif; ?><?php */?>
    ...
    <?php /*?><?php if($this->item->params->get('itemAuthor')): ?>
    <!-- Item Author --> 
  ...
  <!-- Item Title and Author Name, Image for Mobile START-->
    
    <?php if($this->item->params->get('catItemAuthor') && $mobile): ?>
    <!-- Item Author -->
    <?
...
?>
    ...
    <?php if($this->item->params->get('itemDateCreated') && $mobile): ?>
    <!-- Date created --> 
    <div style="float:left; width:100%; margin-bottom:10px;">
        <div style="float:left; line-height:15px;"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </div>
        <?php endif; ?>
    ...
    <?php if ($mobile): ?>
    <h1 style=" margin-top:20px; font-family:Times, 'Times New Roman', serif !important;"><?php echo $this->item->title;?></h1>
    <?php endif; ?>
    
    <!-- Item Author Name and Image for WEB START-->
...
?>
    ...
    <div style="float:left; width:100%; margin-bottom:15px;">
        <div style="margin-top:15px; float:left; margin-left:10px; width:55%; color: #A7A4A4;font-size: 110%;"> <?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?> </div>
        <?php endif; ?>
			 <div style="float:right; width:40%">
...
{itpsharepoint}
    ...
    <?php if($this->item->params->get('itemImage') && !empty($this->item->image) && $mobile): ?>
    <!-- Item Image -->
    <div class="itemImageBlock" style="margin-top:-40px;"> 
        <div style="width:100%; float:left;"> 
    	<a class="" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>"> 
    		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" /> 
        </a> 
    </div>
      <?php if($this->item->params->get('itemImageMainCaption') && !empty($this->item->image_caption)  && $mobile): ?>
      <!-- Image caption --> 
      
      <div class="itemImageCaption"><?php echo $this->item->image_caption; ?></div>
      <?php endif; ?>
      <?php if($this->item->params->get('itemImageMainCredits') && !empty($this->item->image_credits)  && $mobile): ?>
      <!-- Image credits --> 
