...
class plgJoomlamailerCom_virtuemart extends JPlugin {
    ...
    */
    public function getArticleList() {
        ...
        $jlang->load('plg_joomlamailer_virtuemart', JPATH_ADMINISTRATOR, 'en-GB', true);
        $jlang->load('plg_joomlamailer_virtuemart', JPATH_ADMINISTRATOR, $jlang->getDefault(), true);
        $jlang->load('plg_joomlamailer_virtuemart', JPATH_ADMINISTRATOR, null, true);
    ...
    */
    private function renderTable($items) {
        ...
        // load language files. include en-GB as fallback
        $jlang = JFactory::getLanguage();
        $jlang->load('plg_joomlamailer_com_virtuemart', JPATH_ADMINISTRATOR, 'en-GB', true);
        $jlang->load('plg_joomlamailer_com_virtuemart', JPATH_ADMINISTRATOR, $jlang->getDefault(), true);
        $jlang->load('plg_joomlamailer_com_virtuemart', JPATH_ADMINISTRATOR, null, true);
        $jlang->load('com_virtuemart_shoppers', JPATH_SITE . '/components/com_virtuemart', 'en-GB', true);
        $jlang->load('com_virtuemart_shoppers', JPATH_SITE . '/components/com_virtuemart', $jlang->getDefault(), true);
        $jlang->load('com_virtuemart_shoppers', JPATH_SITE . '/components/com_virtuemart', null, true);
