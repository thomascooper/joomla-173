...
class plgJoomlamailerFacebook_icon extends JPlugin {
    ...
    public function getSocialIcon() {
	    ...
	    $jlang->load('plg_joomlamailer_facebook_icon', JPATH_ADMINISTRATOR, 'en-GB', true);
	    $jlang->load('plg_joomlamailer_facebook_icon', JPATH_ADMINISTRATOR, $jlang->getDefault(), true);
	    $jlang->load('plg_joomlamailer_facebook_icon', JPATH_ADMINISTRATOR, null, true);
