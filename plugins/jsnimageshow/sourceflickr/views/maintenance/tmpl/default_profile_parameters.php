...
<div class="control-group">
	...
	<div class="controls">
		...
		<input class="jsn-master jsn-input-xxlarge-fluid" type="text" name ="number_of_images_on_loading" id ="number_of_images_on_loading" value = "<?php echo (isset($flickrParams->number_of_images_on_loading) && $flickrParams->number_of_images_on_loading !='')? $flickrParams->number_of_images_on_loading: '20';?>"/>
	</div>
</div>
...
<input type="hidden" name="image_source" value="sourceflickr"/>
<input type="hidden" name="profile_parameter" value="<?php echo htmlspecialchars ($flickrParamsStr);?>" />
