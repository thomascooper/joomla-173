    ...
    $(document).ready(function(){
        ...
        joomlamailerJS.templates = {
            ...
            logoWidthInfo: function() {
                var logoWidth = $('.headerBar', window.frames['previewIframe'].document).width();
                if (logoWidth) {
            ...
            resetIframe: function() {
                var iframeHeight = $('.backgroundTable', window.frames['previewIframe'].document).height();
                if (iframeHeight){
                    $('#previewIframe').attr('height', (iframeHeight + 50));
                }
            ...
            clearPosition: function (){
                ...
                if (confirm(joomlamailerJS.strings.confirmClearPosition + " " + $('#phPosition option:selected').text() + joomlamailerJS.strings.position)) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            'template': encodeURIComponent($('html', window.frames['previewIframe'].document).html()),
