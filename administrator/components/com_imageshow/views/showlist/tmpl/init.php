	...
	if ( $totalimage > 0){
		...
		foreach ($images->images as $image)
		{
			...
			<div class="<?php echo $itemClass;?><?php echo $selectMode;?>" id="<?php echo $image['image_extid'];?>">
				...
				<input class="item_detail" type="hidden" value="<?php echo  urlencode(json_encode($imageinfo));?>" />
				<div class="item-index"><?php echo $i.'/'.$totalimage;?>
				...
				<div id="item-info-<?php echo $image['image_extid'];?>" class="item-info">
