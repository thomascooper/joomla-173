	...
	<div class="row-fluid">
		<div class="span6">
			<fieldset>
				...
				?>
				<div class="control-group">
					<label class="control-label editlinktip hasTip" title="<?php echo htmlspecialchars(JText::_('SHOWLIST_TITLE_SHOWLIST'));?>::<?php echo htmlspecialchars(JText::_('SHOWLIST_DES_SHOWLIST')); ?>"><?php echo JText::_('SHOWLIST_TITLE_SHOWLIST');?><span class="star"> *</span></label>
					<div class="controls">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input readonly="readonly" class="input-mini" type="text" name="hits" value="<?php echo ($this->items->hits!='')?$this->items->hits:0;?>" />
					</div>
				</div>
				<div class="control-group">
