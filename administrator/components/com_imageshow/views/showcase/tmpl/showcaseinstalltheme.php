...
<div id="jsn-install-theme">
	<h3 class="jsn-section-header"><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></h3>
	<form id="jsn-form-install-theme" enctype="multipart/form-data" action="index.php?option=com_imageshow&controller=showcase&task=showcaseinstalltheme" method="post" name="adminForm">
		...
		<div class="form-actions"><button class="link-button" onclick="submitbutton(); return false;"><?php echo JText::_('SHOWCASE_THEME_INSTALL_THEME'); ?></button></div>
